...
public class FunctionEvaluator {
    ...
    public FunctionEvaluator() throws PMException {
        ...
        addFunctionExecutor(new CurrentUserDevicePairExecutor());
        addFunctionExecutor(new CurrentUserDevicePairNameExecutor());
        addFunctionExecutor(new CurrentTargetNameExecutor());
    }
